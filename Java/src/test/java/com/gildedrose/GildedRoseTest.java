...
class GildedRoseTest {
    ...
    @Test
    void genericItem1() {
        Item[] items = new Item[] { ItemFactory.newItem("foo", 0, 0) };
    ...
    @Test
    void genericItem2() {
        Item[] items = new Item[] { ItemFactory.newItem("foo", 1, 3) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    @Test
    void genericItem3() {
        Item[] items = new Item[] { ItemFactory.newItem("foo", 1, 2) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    void genericItem4() {
        Item[] items = new Item[] { ItemFactory.newItem("foo", 5, 2) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    @Test
    void cheeseItem1() {
        Item[] items = new Item[] { ItemFactory.newItem("Aged Brie", 1, 5) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    @Test
    void cheeseItem2() {
        Item[] items = new Item[] { ItemFactory.newItem("Aged Brie", 3, 48) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    @Test
    void cheeseItem3() {
        Item[] items = new Item[] { ItemFactory.newItem("Aged Brie", 1, 48) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    @Test
    void legendaryItem1() {
        Item[] items = new Item[] { ItemFactory.newItem("Sulfuras, Hand of Ragnaros", 0, 80) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    @Test
    void ticketItem1() {
        Item[] items = new Item[] { ItemFactory.newItem("Backstage passes to a TAFKAL80ETC concert", 15, 15) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    @Test
    void ticketItem2() {
        Item[] items = new Item[] { ItemFactory.newItem("Backstage passes to a TAFKAL80ETC concert", 15, 46) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    @Test
    void ticketItem3() {
        Item[] items = new Item[] { ItemFactory.newItem("Backstage passes to a TAFKAL80ETC concert", 15, 36) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    @Test
    void ticketItem4() {
        Item[] items = new Item[] { ItemFactory.newItem("Backstage passes to a TAFKAL80ETC concert", 15, 21) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    @Test
    void conjuredItem1() {
        Item[] items = new Item[] { ItemFactory.newItem("Conjured item", 1, 8) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    @Test
    void conjuredItem2() {
        Item[] items = new Item[] { ItemFactory.newItem("Conjured item", 3, 3) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
